const FRUITS = [
  'Abricot','Cerise','Raisin',
  'Prune','Figue','Kiwi','Myrtille',
  'Fraise','Ananas','Banane','Framboise',
  'Orange','Mangue','Pomme','Fruit de la passion'
];
...
const FRUIT_DATA = {
  'Abricot':{type:'emoji',val:'🍑'},
  'Cerise':{type:'emoji',val:'🍒'},
  'Raisin':{type:'emoji',val:'🍇'},
  'Prune':{type:'svg',val:SVG_PRUNE},
  'Figue':{type:'svg',val:SVG_FIGUE},
  'Kiwi':{type:'emoji',val:'🥝'},
  'Myrtille':{type:'svg',val:SVG_MYRTILLE},
  'Fraise':{type:'emoji',val:'🍓'},
  'Ananas':{type:'emoji',val:'🍍'},
  'Banane':{type:'emoji',val:'🍌'},
  'Framboise':{type:'svg',val:SVG_FRAMBOISE},
  'Orange':{type:'emoji',val:'🍊'},
  'Mangue':{type:'emoji',val:'🥭'},
  'Pomme':{type:'emoji',val:'🍎'},
  'Fruit de la passion':{type:'svg',val:SVG_PASSION}
};
